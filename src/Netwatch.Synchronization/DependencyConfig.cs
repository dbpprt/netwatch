...
namespace TrafficStats.Synchronization
{
    public static class DependencyConfig
    {
        public static void RegisterDependencies(IUnityContainer container)
        {
            ...
            container
                .RegisterType<ISnmpResultService, SnmpResultService>(new HierarchicalLifetimeManager())
                .RegisterType<IDeviceMonitorService, DeviceMonitorService>(new HierarchicalLifetimeManager())
                .RegisterType<ISnmpScannerService, SnmpScannerService>(new HierarchicalLifetimeManager())
