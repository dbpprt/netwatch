...
{
    public class CollectedTrafficData
    {
        [Key]
        public int Id { get; set; }

        [ForeignKey("MonitoredPort"), Column(Order = 0)]
        public int PortNumber { get; set; }

        [Required]
        [ForeignKey("MonitoredPort"), Column(Order = 1)]
        ...
        [Required]
        public long AbsoluteOctets { get; set; }

        [Required]
        public TrafficType TrafficType { get; set; }

        public TimeSpan? DiffedTimeSpan { get; set; }
    }
}
